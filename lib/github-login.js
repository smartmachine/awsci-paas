...
class GithubLogin extends Construct {
   ...
   */
    constructor(scope, id, options) {
        ...
        const requestModel = options.api.addModel('RequestModel', {
        ...
        // We define the JSON Schema for the transformed valid response
        const responseModel = options.api.addModel('ResponseModel', {
            contentType: 'application/json',
        ...
        const errorResponseModel = options.api.addModel('ErrorResponseModel', {
            contentType: 'application/json',
        ...
        const validator = options.api.addRequestValidator('DefaultValidator', {
