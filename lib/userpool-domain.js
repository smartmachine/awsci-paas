...
class UserPoolDomain extends Construct {
    ...
    constructor(scope, id, options) {
        ...
        new cdk.CfnOutput(scope, "CloudFrontDomain", { value: resource.getAtt('CloudFrontDomain').toString()});
        new cdk.CfnOutput(scope, "RecordChangeStatus", { value: resource.getAtt("RecordChangeStatus").toString()});
        new cdk.CfnOutput(scope, "RecordChangeComment", { value: resource.getAtt("RecordChangeComment").toString()})
