...
class StaticSite extends Construct {
    ...
    constructor(scope, id, options) {
        ...
        new lambda.SingletonFunction(this, 'CloudFrontInvalidationLambda', {
            uuid: 'f9553ec2-c5e9-4b50-996a-5c22d64d1c55',
            code: new lambda.AssetCode('../api/invalidation.zip'),
            handler: 'invalidation',
            timeout: cdk.Duration.seconds(300),
            runtime: lambda.Runtime.GO_1_X,
            events: [new lambdaEventSources.S3EventSource(site, {events: [EventType.OBJECT_CREATED]})]
        });
