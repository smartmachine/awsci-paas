...
const { CloudFrontWebDistribution, SSLMethod, SecurityPolicyProtocol } = require('@aws-cdk/aws-cloudfront');
const { HostedZone, ARecord, AddressRecordTarget } = require('@aws-cdk/aws-route53');
const { CloudFrontTarget, ApiGateway } = require('@aws-cdk/aws-route53-targets/lib');
...
class AwsciStack extends Stack {
    ...
    constructor(scope, id, props) {
        ...
        // Static Website
        const site = new Bucket(this, 'awsci.io', {
            bucketName: "awsci.io",
        ...
        const certARN = 'arn:aws:acm:us-east-1:865054731072:certificate/1c19f070-0b8f-4001-9561-6cb32b740170';
        ...
        // Lambda Function
        const loginLambda = new Function(this, 'AWSCI-LAMBDA', {
            runtime: Runtime.GO_1_X,
            handler: 'login',
            code: Code.fromAsset(path.join(__dirname, '../../awsci-api/login.zip')),
        });

        const dynamoTable = new dynamodb.Table(this, 'sessions', {
            partitionKey: {
                name: 'session_id',
        ...
        const wildcardARN = 'arn:aws:acm:us-east-1:865054731072:certificate/aa30e21f-cb3d-4eb1-bc53-f8710e9a3072';
        const wildcard    = Certificate.fromCertificateArn(this, 'Wildcard', wildcardARN);
